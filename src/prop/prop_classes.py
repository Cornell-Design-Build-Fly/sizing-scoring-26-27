...
# Fixed at 8S by team decision (2026-09-05). Cell count is no longer a design
# variable; the bounds are kept only so existing validation code still works.
DEFAULT_BATTERY_CELL_COUNT = 8
DEFAULT_BATTERY_CELL_COUNT_BOUNDS = (8, 8)
